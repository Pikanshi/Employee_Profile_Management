        ...
        while(true) {
        	...
        	switch(choice){
        	 case 1: System.out.println("Enter ID: ");
        				...
        				boolean result = service.addEmployee(new Employee(id,firstName,lastName,dept,jobTitle,address,email,phoneNumber,birthday,weddingAnniversary));
        		...
        		case 4: System.out.println("Enter id of employee");
				   ...
				   boolean myRes = service.editEmployee(new Employee(id11,firstName1,lastName1,dept1,jobTitle1,address1,email1,phoneNumber1,myBirthDate,myWeddingAnniversary));
				   if(myRes) {
