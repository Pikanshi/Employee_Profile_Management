...
public class Employee {
	 ...
	 public Employee(int id, String firstName, String lastName, String dept, String jobTitle, String address, String emailAddress, String phoneNumber,
	...
	public String toString() {
		return "Employee [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", dept=" + dept + ", jobTitle=" + jobTitle +", address=" + address
